...
print(f"\"test\" == \"testing\" : {'test' == 'testing'}")
...
print(f"not (\"testing\" == \"testing\" and \"Zed\" == \"Cool Guy\") : {not ('testing' == 'testing' and 'Zed' == 'Cool Guy')}")
print(f"1 == 1 and (not (\"testing\" == 1 or 1 == 0)) : {1 == 1 and (not ('testing' == 1 or 1 == 0))}")
print(f"\"chunky\" == \"bacon\" and (not (3 == 4 or 3 == 3)) : {'chunky' == 'bacon' and (not (3 == 4 or 3 == 3))}")
print(f"3 == 3 and (not (\"testing\" == \"testing\" or \"Python\" == \"Fun\")) : {3 == 3 and ( not ('testing' == 'testing' or 'Python' == 'Fun'))}")